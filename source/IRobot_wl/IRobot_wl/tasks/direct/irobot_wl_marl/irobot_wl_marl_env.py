...
from .irobot_wl_marl_env_cfg import IrobotWlMarlEnvCfg


class IrobotWlMarlEnv(DirectMARLEnv):
    cfg: IrobotWlMarlEnvCfg

    def __init__(self, cfg: IrobotWlMarlEnvCfg, render_mode: str | None = None, **kwargs):
